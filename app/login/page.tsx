...
const LogoBackground = () => (
  <svg
    className="absolute inset-0 w-full h-full text-black dark:text-white opacity-[0.06] dark:opacity-[0.15]"
    viewBox="0 0 192 192"
      ...
      <div className="relative z-10 w-full max-w-sm space-y-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <p className="text-center text-sm text-neutral-500">
            ...
            <Link href="/register" className="text-black dark:text-white underline underline-offset-2 font-medium">
              Register
            </Link>
          </p>
        </form>
