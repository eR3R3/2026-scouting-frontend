...
export default function RegisterPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-white dark:bg-black px-4 overflow-hidden">
      <LogoBackground />
      ...
      <div className="relative z-10 w-full max-w-sm space-y-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          {error && (
            <div className="text-sm text-black dark:text-white bg-neutral-100 dark:bg-neutral-900 border border-neutral-300 dark:border-neutral-700 rounded-lg p-3">
              {error}
            </div>
          )}

          <div>
            <label htmlFor="name" className="block text-xs font-medium text-neutral-500 uppercase tracking-wider mb-1.5">
              Name
            </label>
            <input
              id="name"
              ...
              className="w-full px-4 py-3 rounded-lg border border-neutral-300 dark:border-neutral-700
                bg-transparent text-black dark:text-white placeholder-neutral-400
                focus:ring-1 focus:ring-black dark:focus:ring-white focus:border-black dark:focus:border-white
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-xs font-medium text-neutral-500 uppercase tracking-wider mb-1.5">
              Confirm Password
            </label>
            <input
              id="confirmPassword"
          ...
          <p className="text-center text-sm text-neutral-500">
            ...
            <Link href="/login" className="text-black dark:text-white underline underline-offset-2 font-medium">
              Sign In
            </Link>
          </p>
        </form>
